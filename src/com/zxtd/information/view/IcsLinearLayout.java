...
class IcsLinearLayout extends LinearLayout {
   ...
   //     /* 2 */ android.R.attr.dividerPadding,
    ...
    private static final int LL_DIVIDER_HEIGHT = 1;
  ...
  //  private int mDividerPadding;
    ...
    public IcsLinearLayout(Context context, int themeAttr) {
        ...
        setDivider(a.getDrawable(IcsLinearLayout.LL_DIVIDER));
        mDividerWidth = a.getDimensionPixelSize(LL_DIVIDER_HEIGHT, 0);
...
//        }
    ...
    private void drawHorizontalDivider(Canvas canvas, int top) {
        mDivider.setBounds(getPaddingLeft(), top,
                getWidth() - getPaddingRight() , top + mDividerHeight);
        mDivider.draw(canvas);
    }

    private void drawVerticalDivider(Canvas canvas, int left) {
        mDivider.setBounds(left, getPaddingTop() ,
                left + mDividerWidth, getHeight() - getPaddingBottom());
        mDivider.draw(canvas);
    }
