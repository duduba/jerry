...
public class EggCalendar extends View implements View.OnTouchListener{
	...
	protected void onDraw(Canvas canvas) {
		...
		// 上一月/下一月
		//canvas.drawPath(surface.preYearBtnPath, surface.monthChangeBtnPaint);
		...
		private void calculateDate() {
			...
			calendar.set(Calendar.DAY_OF_MONTH, 0);
			//Log.d(TAG, "m:" + calendar.get(Calendar.MONTH) + " d:" + calendar.get(Calendar.DAY_OF_MONTH));
		...
		*/
		private class Surface {
			...
			public Path preYearBtnPath; //上一年
			public Path nextYearBtnPath;//下一年
		...
		public void init() {
			...
			/*preYearBtnPath=new Path();
			preYearBtnPath.moveTo(monthChangeWidth/2f, monthHeight/2f);
			preYearBtnPath.rLineTo(btnHeight/2f, -btnHeight/2f);
			preYearBtnPath.rLineTo(0, btnHeight);
			preYearBtnPath.close();
			*/
