...
import com.zxtd.information.adapter.ZoomImageAdapter;
...
public class ShowWebImageActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			...
			if(extras.containsKey("isCache")){
				//isCache=extras.getBoolean("isCache",false);
			}
		}
		...
		ZoomImageAdapter imageAdapter = new ZoomImageAdapter(this, imageBeans);
			...
			Drawable drawable = asyncImageLoader.loadCacheDrawable(imageUrl, null, 0, new ImageListCallback() {
				...
				public void imageLoaded(Drawable imageDrawable, View view, int position) {
					if(imageDrawable != null){
						...
						Toast.makeText(ShowWebImageActivity.this, "图片已保存到相册！", Toast.LENGTH_SHORT).show();
					}else{
						Toast.makeText(ShowWebImageActivity.this, "图片下载失败，请重试！", Toast.LENGTH_SHORT).show();
					}
				}
