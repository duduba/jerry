...
public class RecommandLayout extends MyRelativeLayout {
	
	private int userId;
	public RecommandLayout(Context context,int userId,String from) {
		super(context);
	...
	CallBack callBack=new CallBack(){
		public List<FansFocusBean> loadData(int pageIndex) {
			...
			return manager.getRecommand(Constant.RequestCode.MINE_REQUEST_RECOMMEND, userId, pageIndex);
		}
	};
