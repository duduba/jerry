...
public class NewAlbumsAdapter extends PagerAdapter {
	...
	public NewAlbumsAdapter(Context context, List<ImageBean> imageBeans,boolean isLoc){
	...
	public void setUrlImage(String url, GestureImageView zoomImageView, int position, final LinearLayout netError, final ProgressBar progressBar){
		...
		if(!isLocal){
			...
			zoomImageView.setImageBitmap(ImageUtils.showBitmap(url));
			progressBar.setVisibility(View.GONE);
		}
